...
`Instruction 2: Campo de input para o usuário digitar o nome da cidade que ele deseja buscar os dados meteorológicos.`

`Instruction 3: Botão de submit para enviar a requisição HTTP.`

`Instruction 4: Formatar os dados meteorológicos obtidos em um formato amigável ao usuário.`

`Instruction 5: Estilize o app com o CSS e uma interface amigável.`
